<template>
  <div class="bg-white dark:bg-gray-800 ">
     <!-- Desktop sidebar -->
        <aside class="z-20 flex-shrink-0 w-64 overflow-y-auto bg-white dark:bg-gray-800 hidden lg:block">
          <div class="py-4 text-gray-500 dark:text-gray-400">
           <Logo />
            ...
            <div class="w-full flex justify-center mt-6">
              <div class="relative hidden rounded-full lg:block flex justify-center items-end" style="height:100px; width:100px;">
